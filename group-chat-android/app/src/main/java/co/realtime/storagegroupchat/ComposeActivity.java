	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		save.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				StorageHandler.selfHandler.pushMsg(new Message(PreferencesManager.getInstance(ComposeActivity.this).loadUser(), text.getText().toString(), sdf.format(new Date())), channel);
				finish();
			}
		});
